...
if __name__ == "__main__":
    ...
    path = '/home/proj_vode/I3Ddata&X3Ddata/kidnap/'
    ...
    for i in file_list:
        ...
        weights=torch.load('x3d_charades_rgb_sgd_024000.pt')["model_state_dict"]
        ...
        for j,data in enumerate(trainloader):
            ...
            target_dir = '/home/proj_vode/data_numpy_X3D_M_re/kidnap/'+i+'/'
