...
if __name__ == "__main__":
    ...
    #file_path = './test_kidnap.txt'
    file_path = './test_fight.txt'
    with open(file_path) as f:
        lines = f.read().split(', ')

    lines = [line.rstrip('\n') for line in lines]

    path = '/projects/vode/16_segments/fight/'

    for i in lines:#file_list:#final:#file_list:
        ...
        make = torch.zeros((1,3,16,224,224))
        ...
        # weights=torch.load('./weightFile/x3d_multigrid_kinetics_rgb_sgd_204000.pt')["model_state_dict"]

 
        # model.load_state_dict(weights)

        weights=torch.load('/home/dahee333/custom_X3D/checkPoint/x3d-checkPoint.pt')#["state_dict"]
        ...
        for j,data in enumerate(trainloader):
            ...
            target_dir = '/home/dahee333/X3D/numpy/fight/'+i+'/'
